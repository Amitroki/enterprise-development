...
public class CarModelGenerationsController(IApplicationService<CarModelGenerationDto, CarModelGenerationCreateUpdateDto> service) : ControllerBase
{
    [HttpGet]
    public async Task<ActionResult<List<CarModelGenerationDto>>> GetAll() => Ok(await service.ReadAll());

    [HttpGet("{id:int}")]
    public async Task<ActionResult<CarModelGenerationDto>> Get(int id)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, CarModelGenerationCreateUpdateDto dto)
    {
